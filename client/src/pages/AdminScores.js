...
const AdminScores = () => {
  ...
  const fetchData = React.useCallback(async () => {
    try {
      ...
      const [statsResponse, quizzesResponse, scoresResponse] =
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">
            Monitor user performance and quiz analytics
          </p>
        </div>
        <div className="flex space-x-4">
          ...
          <button
            onClick={() =>
              setViewMode(viewMode === "scores" ? "analytics" : "scores")
            }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFilters({ ...filters, quizId: e.target.value, page: 1 })
              }
                    ...
                    <div className="mt-2">
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${Math.min(quiz.averageScore, 100)}%`,
                          }}
                        ></div>
                      </div>
                    </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-bold text-gray-900">
                  {statistics.totalUsers > 0
                    ? (
                        (statistics.usersWithScores / statistics.totalUsers) *
                        100
                      ).toFixed(1)
                    : 0}
                  %
