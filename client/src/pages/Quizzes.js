...
const Quizzes = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">Constitutional Quizzes</h1>
        <p className="text-gray-600">Test your knowledge of the Indian Constitution with our interactive quizzes</p>
      </div>
            ...
            <div key={quiz._id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className={`inline-block text-xs font-semibold px-2.5 py-0.5 rounded ${getDifficultyColor(quiz.difficulty)}`}>
                    {quiz.difficulty}
                  </span>
                </div>
