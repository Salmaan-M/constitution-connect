...
const QuizResult = () => {
  ...
  const { results, score, totalQuestions, percentage, passed, quizTitle } = location.state || {};
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">It looks like you haven't completed a quiz yet.</p>
          <Link
            to="/quizzes"
  ...
  const getScoreMessage = (percentage) => {
    if (percentage >= 90) return 'Outstanding! You have excellent knowledge of the Constitution!';
    if (percentage >= 80) return 'Great job! You have a strong understanding of constitutional principles.';
    if (percentage >= 70) return 'Good work! You have a solid grasp of the material.';
    if (percentage >= 60) return 'Not bad! You passed, but consider reviewing some topics.';
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <div className="text-3xl font-bold text-gray-800 mb-2">{totalQuestions - score}</div>
            <div className="text-gray-600">Incorrect Answers</div>
          </div>
          
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <div className="text-3xl font-bold text-gray-800 mb-2">{totalQuestions}</div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center">
                    ...
                    <span className={`text-sm ${
                      ...
                      {result.userAnswer !== null ? `Option ${result.userAnswer + 1}` : 'Not answered'}
                    </span>
                  </div>
