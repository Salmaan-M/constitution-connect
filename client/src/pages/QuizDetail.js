        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-2xl font-bold text-gray-800">{quiz.difficulty}</div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-right">
              ...
              <div className={`text-2xl font-bold ${timeLeft < 60 ? 'text-red-600' : 'text-gray-800'}`}>
                {formatTime(timeLeft)}
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">
                You still have {quiz.questions.length - answers.filter(answer => answer !== null).length} unanswered questions. 
