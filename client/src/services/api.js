...
export const blogsAPI = {
  ...
  update: (id, blogData) => apiRequest(`/blogs/${id}`, {
    method: 'PUT',
    body: JSON.stringify(blogData),
  }),
...
export const quizzesAPI = {
  ...
  create: (quizData) => apiRequest('/quizzes', {
    method: 'POST',
    body: JSON.stringify(quizData),
  }),
  
  update: (id, quizData) => apiRequest(`/quizzes/${id}`, {
    method: 'PUT',
    body: JSON.stringify(quizData),
  }),
  
  delete: (id) => apiRequest(`/quizzes/${id}`, {
    method: 'DELETE',
  }),
...
export const contactAPI = {
  ...
  updateStatus: (id, statusData) => apiRequest(`/contact/admin/${id}/status`, {
    method: 'PUT',
    body: JSON.stringify(statusData),
  }),
  
  delete: (id) => apiRequest(`/contact/admin/${id}`, {
    method: 'DELETE',
  }),
};
